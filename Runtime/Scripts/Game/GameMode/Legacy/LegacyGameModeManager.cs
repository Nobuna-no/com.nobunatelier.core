...
namespace NobunAtelier
{
    ...
    /// </summary>
    public class LegacyGameModeManager : MonoBehaviour
    {
        public static LegacyGameModeManager Instance { get; private set; }

        public IReadOnlyList<LegacyGameModeParticipant> PlayersController => m_participants;
        ...
        public IList<LegacyGameModeParticipant> Participants => m_participants;
        private List<LegacyGameModeParticipant> m_participants = new List<LegacyGameModeParticipant>();
        ...
        public virtual bool IsParticipantAlreadyInGameMode(LegacyGameModeParticipant participant)
        {
            return m_participants != null && m_participants.Contains(participant);
        }

        public virtual bool AddPlayer(LegacyGameModeParticipant participant)
        {
            ...
            var humanPlayer = participant as LegacyPlayerInputParticipant;
        ...
        public virtual bool RemovePlayer(LegacyGameModeParticipant participant, bool destroyChildrenPrefab = true)
        {
            if (!m_participants.Contains(participant))
            {
                return false;
        ...
        public virtual bool AddAIPlayer(LegacyGameModeParticipant bot)
        {
            ...
            var botPlayer = bot as LegacyAIParticipant;
        ...
        public virtual bool RemoveAIPlayer(LegacyGameModeParticipant bot, bool destroyChildrenPrefab = true)
        {
            if (!m_participants.Contains(bot))
            {
                return false;
        ...
        public virtual bool RemovePlayerWithoutController(LegacyGameModeParticipant participant)
        {
            if (!m_participants.Contains(participant))
            {
                return false;
