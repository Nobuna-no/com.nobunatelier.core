...
namespace NobunAtelier
{
    ...
    public class LegacyPlayerManager : MonoBehaviour
    {
        public static LegacyPlayerManager Instance { get; private set; }
        ...
        private LegacyPlayerInputParticipant m_playerPrefab;

        [SerializeField]
        private LegacyAIParticipant m_botPrefab;
        ...
        private LegacyGameModeManager m_gamemode;
        private List<LegacyPlayerInputParticipant> m_players = new List<LegacyPlayerInputParticipant>();
        private List<LegacyAIParticipant> m_bots = new List<LegacyAIParticipant>();
        private List<LegacyGameModeParticipant> m_pendingPlayers = new List<LegacyGameModeParticipant>();
        ...
        [Button(enabledMode: EButtonEnableMode.Playmode)]
        public virtual void RemoveAIPlayer(LegacyAIParticipant botToRemove = null, bool removeFromGameMode = true)
        {
            if (botToRemove == null)
            {
                if (m_bots.Count > 0)
            ...
            {
                m_gamemode = FindFirstObjectByType<LegacyGameModeManager>();
                if (m_gamemode)
                {
        ...
        {
            m_players.Remove(obj.GetComponent<LegacyPlayerInputParticipant>());
        ...
        protected virtual void OnHumanPlayerJoined(PlayerInput obj)
        {
            ...
            m_pendingPlayers.Add(obj.GetComponent<LegacyPlayerInputParticipant>());
        ...
        private void FixedUpdate()
        {
            ...
            for (int i = 0, c = m_pendingPlayers.Count; i < c; ++i)
            {
                ...
                if (m_pendingPlayers[i].IsAI)
                {
                    ...
                    LegacyAIParticipant newBotPlayer = m_pendingPlayers[i] as LegacyAIParticipant;
                ...
                else
                {
                    ...
                    LegacyPlayerInputParticipant newHumanPlayer = m_pendingPlayers[i] as LegacyPlayerInputParticipant;
